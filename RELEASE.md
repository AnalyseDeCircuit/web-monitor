...
- Docker images pushed to `ghcr.io/AnalyseDeCircuit/opskernel` (tags: `vX.Y.Z`, `latest`) using `buildx` (linux/amd64, linux/arm64)

Pull example:

```bash
docker pull ghcr.io/AnalyseDeCircuit/opskernel:v0.1.0
```
